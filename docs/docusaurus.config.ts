    ...
    [
      'classic',
      {
        docs: {
          ...
          routeBasePath: '/',
          editUrl: 'https://github.com/bogoware/Localization/tree/rel/prod/docs/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://www.nuget.org/packages/Bogoware.Localization',
          label: 'NuGet',
          position: 'right',
        },
        {
          href: 'https://github.com/bogoware/Localization',
          label: 'GitHub',
          position: 'right',
        },
      ],
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              href: 'https://github.com/bogoware/Localization/issues',
            },
          ],
        },
      ],
