...
description: How the localization formatter resolves strings through a four-step provider chain
sidebar:
  order: 3
---
...
<LinkCard title="Custom Providers" description="Implement self-providers and DI providers for complex scenarios" href="/Localization/guides/custom-providers/" />
...
<LinkCard title="Culture Fallback" description="How the registry walks up the culture hierarchy" href="/Localization/concepts/culture-fallback/" />
