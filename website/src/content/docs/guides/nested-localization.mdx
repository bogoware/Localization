...
description: Recursive formatting of nested ILocalizable properties through the full resolution chain
sidebar:
  order: 6
---
...
<Aside type="tip" title="Culture propagation">
...
<LinkCard title="Provider Chain" description="The four-step resolution order applied at each nesting level" href="/Localization/concepts/provider-chain/" />
<LinkCard title="Localizable Types" description="Define types that participate in nested localization" href="/Localization/concepts/localizable-types/" />
<LinkCard title="JSON Serialization" description="Nested ILocalizable properties are also handled during serialization" href="/Localization/guides/json-serialization/" />
