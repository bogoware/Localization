...
description: Implement custom localization providers for dynamic content, DI-based logic, and generic types
sidebar:
  order: 2
---
...
<Aside type="tip" title="Fallthrough behavior">
...
<LinkCard title="Provider Chain" description="Understand the full four-step resolution order" href="/Localization/concepts/provider-chain/" />
<LinkCard title="Localizable Types" description="Define types that participate in the localization system" href="/Localization/concepts/localizable-types/" />
<LinkCard title="JSON Templates" description="The standard template-based approach for most use cases" href="/Localization/guides/json-templates/" />
