...
description: Wire Bogoware.Localization into the ASP.NET Core pipeline with per-request culture and automatic JSON localization
sidebar:
  order: 4
---
...
2. **Define endpoints with localizable responses**
...
<LinkCard title="JSON Serialization" description="Understand the three serialization modes and attribute controls" href="/Localization/guides/json-serialization/" />
