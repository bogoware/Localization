...
description: Create, organize, and load JSON template files for type-safe localization
sidebar:
  order: 1
---

import { Tabs, TabItem, Aside, FileTree, LinkCard } from '@astrojs/starlight/components';
...
<Aside type="tip" title="Discovering generic type keys">
...
<Aside type="tip" title="Editor support">
...
<Aside type="tip" title="Satellite assembly prevention">
...
<LinkCard title="Custom Providers" description="Implement providers for scenarios beyond JSON templates" href="/Localization/guides/custom-providers/" />
<LinkCard title="ASP.NET Core Integration" description="Wire localization into the ASP.NET Core pipeline" href="/Localization/guides/aspnetcore-integration/" />
