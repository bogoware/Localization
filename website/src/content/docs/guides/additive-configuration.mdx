...
description: Layer localization templates from multiple sources with last-loaded-wins override semantics
sidebar:
  order: 5
---
...
<LinkCard title="JSON Templates" description="Template file format, organization strategies, and loading methods" href="/Localization/guides/json-templates/" />
<LinkCard title="Localization Registry" description="How the registry stores and resolves template mappings" href="/Localization/concepts/localization-registry/" />
